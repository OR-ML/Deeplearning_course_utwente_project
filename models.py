...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        # noise_sizex1x1    --> 128x4x4
        self.deconv1 = deconv(in_channels=noise_size, out_channels=out_channels_layer_1,
                              kernel_size=kernel_size, padding=0, stride=1)
        # 128x4x4           --> 64x8x8
        self.deconv2 = deconv(in_channels=out_channels_layer_1, out_channels=out_channels_layer_2,
                              kernel_size=kernel_size)
        # 64x8x8            --> 32x16x16
        self.deconv3 = deconv(in_channels=out_channels_layer_2, out_channels=out_channels_layer_3,
                              kernel_size=kernel_size)
        # 32x16x16          --> 3x32x32
        self.deconv4 = deconv(in_channels=out_channels_layer_3, out_channels=out_channels_layer_4,
                              kernel_size=kernel_size, batch_norm=False)
...
class DCDiscriminator(nn.Module):
    ...
    def __init__(self, conv_dim=64):
        ...
        self.conv1 = conv(in_channels=in_channel, out_channels=out_channel_layer_1, kernel_size=kernel_size, init_zero_weights=init_zero_weights)
        self.conv2 = conv(in_channels=out_channel_layer_1, out_channels=out_channel_layer_2, kernel_size=kernel_size, init_zero_weights=init_zero_weights)
        self.conv3 = conv(in_channels=out_channel_layer_2, out_channels=out_channel_layer_3, kernel_size=kernel_size, init_zero_weights=init_zero_weights)
        self.conv4 = conv(in_channels=out_channel_layer_3, out_channels=out_channel_layer_4, kernel_size=kernel_size
                          ,padding=0, stride=1, batch_norm=False, init_zero_weights=init_zero_weights)
